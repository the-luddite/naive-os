...
#define READ_TIMER (*(volatile unsigned long *)(CONFIG_SYS_TIMERBASE+4))
...
int timer_init (void)
{
	...
	*(volatile unsigned long *)(CONFIG_SYS_TIMERBASE + 0) = TIMER_LOAD_VAL;
	 ...
	 *	wrapping	 0
	 */
	*(volatile unsigned long *)(CONFIG_SYS_TIMERBASE + 8) = 0x000000C2;
#else
	/* Set timer to be
	 *	enabled		 1
	 *	free-running	 0
	 ...
	 *	XX		00
	 */
	*(volatile unsigned long *)(CONFIG_SYS_TIMERBASE + 8) = 0x00000088;
#endif
